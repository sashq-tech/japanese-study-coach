...
if (indexSource.indexOf("vocabulary-lessons.js") > indexSource.indexOf("app.js?v=59")) {
...
if (workerContext.__shell.CACHE_NAME !== "japan-ready-coach-v59") throw new Error("Expected service worker v59.");
for (const asset of ["./vocabulary-lessons.js", "./app.js?v=59", "./styles.css?v=59"]) {
